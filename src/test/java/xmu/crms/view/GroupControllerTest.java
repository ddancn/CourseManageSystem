...
public class GroupControllerTest {
	...
	public void testGetGrade() throws Exception {
		mvc.perform(get("/group/{groupId}/grade",1))
	    	.andExpect(status().isOk())
	    	.andExpect(jsonPath("$.presentationGrades[0]").exists())
	    	.andExpect(jsonPath("$.presentationGrades[0].topicID").isNumber())
	    	.andExpect(jsonPath("$.presentationGrades[0].grade").isNumber())
